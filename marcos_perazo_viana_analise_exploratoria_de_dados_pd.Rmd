...
```{r desc variavel Altura x Rebotes, echo = TRUE}
dados %>% dplyr::select(Altura, RPG) %>% summarytools::descr() %>% kable()
```

```{r desc variavel Altura x Rebotes sem kable, echo = TRUE}
dados %>% dplyr::select(Altura, RPG) %>% summarytools::descr()
```

```{r desc variavel Altura x Rebotes com estilo, echo = TRUE}
dados %>% dplyr::select(Altura, RPG) %>% summarytools::descr(., style = 'rmarkdown') %>% kable()
```
