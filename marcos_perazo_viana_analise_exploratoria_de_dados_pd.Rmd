...
```{r Dispersão Altura e Rebotes, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
dados %>% 
...
```{r Dispersão Pontos e Peso, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
dados %>% 
...
```{r Dispersão Pontos e Assistências, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
dados %>% 
...
```{r Dispersão Pontos e Rebotes, include=TRUE, echo=FALSE ,message=FALSE, warning=FALSE}
dados %>% 
...
```{r Dispersão Altura e Assistências, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
dados %>% 
...
```{r Histograma de pontos por jogo, echo=FALSE}
...
```{r Histograma de assistências por jogo, echo=FALSE}
dados %>% dplyr::select(APG) %>% ggplot(aes(x=APG)) +
  geom_histogram() + labs(title='Histograma de assistências por jogo', x='Assistências por jogo', y='Quantidade de jogadores')
```

```{r Histograma de rebotes por jogo, echo=FALSE}
dados %>% dplyr::select(RPG) %>% ggplot(aes(x=RPG)) +
  geom_histogram() + labs(title='Histograma de rebotes por jogo', x='Pontos por jogo', y='Quantidade de jogadores')
```

```{r Histograma de Altura, echo=FALSE}
dados %>% dplyr::select(Altura) %>% ggplot(aes(x=Altura)) +
  geom_histogram() + labs(title='Histograma de Altura', x='Altura', y='Quantidade de jogadores')
```

```{r Histograma de Peso, echo=FALSE}
dados %>% dplyr::select(Peso) %>% ggplot(aes(x=Peso)) +
  geom_histogram() + labs(title='Histograma de Peso', x='Peso', y='Quantidade de jogadores')
```
